...
<div class="container disable">
	...
	<div class="wrapper">
		<form method="post" action="addDiary" enctype="multipart/form-data" id="diaryUpload">
			<input type="hidden" value="${sessionScope.sessionID }" name="dwriter" id="dwriter"> <label for="dtitle">제목</label> <input type="text" id="dtitle" name="dtitle" required="required">
